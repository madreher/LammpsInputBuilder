...
class InstructionExtension(Extension):
    ...
    def fromDict(self, d: dict, version: int):
        ...
        self.instruction = loader.dictToInstruction(d["instruction"], version=version)
...
class ManualExtension(Extension):
    def __init__(self, extensionName: str = "defaultManualExtension", doCmd:str = "", undoCmd:str = "") -> None:
        super().__init__(extensionName=extensionName)
        self.doCmd = doCmd
