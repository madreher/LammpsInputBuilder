...
class TemplateSection(Section):
    ...
    def generateSections(self) -> List[Section]:
        raise NotImplementedError("The class {self.__class__.__name__} cannot be used directly. Please use a subclass and implement the function generateSections() or override the function addAllCommands().")
